...
class KYCItem extends item_js_1.Item {
    ...
    toHintedObject() {
        return Object.assign(Object.assign({}, super.toHintedObject()), { contract: this.contract.toString(), kycid: this.service.toString(), currency: this.currency.toString() });
    }
}
