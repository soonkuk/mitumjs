...
exports.StringAssert = exports.Assert = exports.MitumError = exports.ECODE = void 0;
exports.ECODE = {
    UNKNOWN: "EC_UNKNOWN",
...
class MitumError extends Error {
    ...
    static new() {
        return new MitumError(exports.ECODE.UNKNOWN);
    }
    static detail(code, msg) {
        return new MitumError(code !== null && code !== void 0 ? code : exports.ECODE.UNKNOWN, msg);
    }
}
